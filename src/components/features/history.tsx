      ...
      <ScrollView contentInsetAdjustmentBehavior="automatic">
        ...
        <View
          ...
          <View style={styles.buttonView}>
            <Button
              title="REPORTS"
              onPress={() => navigate(ScreenNames.ReportsScreen, {type: 'history', hospName: hospName, logo: logo, hospitalId: hospitalId})}
            />
          </View>
          ...
          <View style={styles.buttonView}>
            <Button
              title="UPDATES"
              onPress={() => navigate(ScreenNames.UpdatesScreen, {type: 'history', hospName: hospName, logo: logo, hospitalId: hospitalId})}
            />
          </View>
          ...
          <View style={styles.buttonView}>
            <Button
              title="BILLING"
              onPress={() => navigate(ScreenNames.BillingScreen, {type: 'history', hospName: hospName, logo: logo, hospitalId: hospitalId})}
            />
          </View>
