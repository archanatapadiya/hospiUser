...
// 
const onResetPass = async(new_password: string, resetUserId: string, navigation: any) => {
          ...
          <React.Fragment>
            <View style={Styles.mainContainer} >
              ...
              <View style={Styles.container}>
                ...
                <Text style={{textAlign: 'center', fontWeight: 'bold', fontSize: 18, marginBottom: 15}}> Please enter your new password</Text>
                  ...
                  <Text style={Styles.formErrorMessage}>
                    {formikProps.touched.new_password && formikProps.errors.new_password}
                  </Text>
